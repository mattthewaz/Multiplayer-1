    ...
    public static class SettingsReader
    {
        ...
        public static ServerSettings ReadServerSettings()
        {
            ...
            if (!settingIni.File.Exists)
            {
                ...
                MpLog.Error($"{_settingsFilename} does not exist. Creating one with default values. Please modify file and rerun.");
        ...
        public static ServerSettings ReadIniFile(IniFile settingIni)
        {
            ...
            if (!valid)
            {
                MpLog.Error("Errors were discovered in ini file. Please correct errors before rerunning.");
                return null;
            }
        ...
        public static string ReadIniEntry(IniFile settingIni, string keyName, string defaultValue, string sectionName = null)
        {
            if (!settingIni.KeyExists(keyName, sectionName))
            {
                ...
                MpLog.Error($"Property {keyName} was not found in ini file. An entry has been created with a defualt value. Please modify value and rerun.");
                return null;
            }
            ...
            {
                MpLog.Error($"Property {keyName} was not defined. Please modify value and rerun.");
                return null;
            }
